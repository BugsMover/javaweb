...
<html>
  <head>
     ...
     $("#yzmImg").attr("src","Kaptcha.jpg?"+Math.floor(Mathc.random()*100)); 
     }
     //提交
     function doSubmit(){
        ...
        if(verifyCodeValue.replace(/\s/g,"")==""){
         ...
         //提交前先异步检查验证码是否输入正确
         var verifyUrl="${pageContext.request.contextPath}/servlet/VerifyServlet?"
         verifyCode="+verifyCodeValue;$.ajax({
           type:"GET",
           url:verifyUrl,
